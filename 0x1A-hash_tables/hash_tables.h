 ...
 * Each cell of this array is a pointer to the first node of a linked list,
 * beacause we want our HashTable to use a Chaining collision handling
...
void void shash_table_print(const shash_table_t *ht);
